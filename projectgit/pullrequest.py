    ...
    while True:
        ...
        try:
            auth = github.get_user().create_authorization(
                scopes=['repo'],
                note='Git_Source_Code_Management {0}'.format(str(uuid4())))
            return github, auth
...
if __name__ == '__main__':
    create_pull_request("/home/humour_infinite/Desktop/Git_Source_Code_Management", "new", "master", "gshubh", "origin")